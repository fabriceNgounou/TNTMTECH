...
return [
    ...
    // Compte administrateur créé par le seeder. À définir dans les variables
    // d'environnement : le dépôt est public, aucun secret ne doit y figurer.
    'admin' => [
        'name' => env('ADMIN_NAME', 'Administrateur TNTMTECH'),
        'email' => env('ADMIN_EMAIL', 'admin@tntmtech.cm'),
        'password' => env('ADMIN_PASSWORD', 'Tntmtech@2026'),
    ],
